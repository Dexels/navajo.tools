...
public class TmlBrowser extends BaseNavajoView implements INavajoScriptListener, IServerEntryListener {
    ...
    private final static Logger logger = LoggerFactory.getLogger(TmlBrowser.class);
    ...
    public void createPartControl(Composite parent) {
        ...
        // headComp.setLayoutData(new
        // TableWrapData(TableWrapData.FILL_GRAB,TableWrapData.TOP));
    ...
    public void back() {
        ...
        // System.err.println("Could not find anything decent on the
        // historystack");
        // return;
        // }
