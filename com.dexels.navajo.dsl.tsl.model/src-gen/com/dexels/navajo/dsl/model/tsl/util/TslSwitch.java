...
public class TslSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TslPackage.TML: {
				Tml tml = (Tml)theEObject;
				T result = caseTml(tml);
				if (result == null) result = caseElement(tml);
			...
			case TslPackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TslPackage.MESSAGE: {
			...
			case TslPackage.REQUIRED: {
				Required required = (Required)theEObject;
				T result = caseRequired(required);
				if (result == null) result = caseElement(required);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TslPackage.OPTION: {
			...
			case TslPackage.VALIDATIONS: {
				Validations validations = (Validations)theEObject;
				T result = caseValidations(validations);
				if (result == null) result = caseElement(validations);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TslPackage.COMMENT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Tml</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Tml</em>'.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Possible Expression</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Possible Expression</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePossibleExpression(PossibleExpression object) {
		return null;
	}
	 ...
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Expression Tag</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
